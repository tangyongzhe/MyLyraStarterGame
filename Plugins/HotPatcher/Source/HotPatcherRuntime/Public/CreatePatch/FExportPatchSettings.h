...
struct FCookAdvancedOptions
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TMap<TObjectPtr<UClass>,int32> OverrideNumberOfAssetsPerFrame;
	FORCEINLINE const TMap<TObjectPtr<UClass>,int32>& GetOverrideNumberOfAssetsPerFrame()const{ return OverrideNumberOfAssetsPerFrame; }
